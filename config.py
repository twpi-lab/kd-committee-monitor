...
MONITOR_URLS = [
    ...
    {
        "name": "청년DB",
        "url": "https://www.2030db.go.kr/user/ntt/BBS_0000000000000005/nttList.do",
        "base": "https://www.2030db.go.kr",
        "ssl": True,
        "parser": "youthdb",
        "detail_url": "https://www.2030db.go.kr/user/ntt/BBS_0000000000000005/{ntt_id}/selectNttDetail.do",
    },
    {
        "name": "국가교육위원회",
        "url": "https://www.ne.go.kr/user/bbs/BD_selectBbsList.do?q_bbsSn=1003",
        "base": "https://www.ne.go.kr",
        "ssl": True,
        "parser": "default",
    },
    {
